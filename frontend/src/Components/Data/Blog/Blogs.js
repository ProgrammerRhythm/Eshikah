const Blog = [
    ...
    {title: 'Tips for debugging and troubleshooting code',img: 'https://www.linkpicture.com/q/My-project-4.png',By:'Rhythm Munshi',content: `Debugging and troubleshooting code can be a frustrating and time-consuming task for any programmer. However, with the right approach and tools, it can be made much easier. In this blog post, we will explore some tips for debugging and troubleshooting code that will help you to quickly identify and fix problems in your code.
